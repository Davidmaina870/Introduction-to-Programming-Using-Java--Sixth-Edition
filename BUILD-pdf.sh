...
if ! $XALAN_COMMAND -xsl convert-tex.xsl -in javanotes6-tex.xml -out tex/javanotes6.tex ; then
   echo
...
if ! mv javanotes6.pdf $BUILD_OUTPUT_DIR ; then
